...
#define COUNTS_PER_REV1 904             // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 898           // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 897              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 886            // wheel4 encoder's no of ticks per rev
...
// MOTOR PINS
  ...
  #define MOTOR1_PWM 15 //Pin no 21 is not a PWM pin on Teensy 4.x, you can swap it with pin no 1 instead.
