...
class MPU9250IMU: public IMUInterface 
{
    ...
    public:
        ...
        bool startSensor() override
        {
            ...
            bool ret;
            accelgyro_.initialize();
            // let the main I2C bus talk directly to the AK8963 magnetometer
            // on the MPU9250's auxiliary I2C bus (needed for USE_AK8963_MAG);
            // I2C_MST_EN must be off for BYPASS_EN to take effect
